...
export const ClientInfo = ({
  ...
  const optionsStudio = [
    ...
    { value: "Студия 1", label: "Студия 1" },
    { value: "Студия 2", label: "Студия 2" },
  ];
    ...
    >
      ...
      >
        <div className={"bg-[#F7F5F4] rounded-[16px] h-[60%] p-[32px]"}>
          ...
          <p
            className={
              "text-[#030303] uppercase text-[24px] leading-[26px] font-['PT-Roo-t-UI'] font-medium mb-5"
            }
          >
            {t("manager_online")}
          </p>
        ...
        <div className={"h-full"}>
          ...
          >
            ...
            <div className={"flex justify-start gap-4 items-center mb-6"}>
              ...
              <p
                className={
                  "text-[#040404] text-[18px] leading-[26px] font-['PT-Root-UI'] font-regular"
                }
              >
                {t("women_only")}
              </p>
            ...
            <div className={"md:w-[380px] w-full"}>
              ...
              <div className="text-[#040404] text-[18px] leading-[26px] font-normal font-['PT-Root-UI'] w-full border-[#D4D3D2] border-[1px] rounded-[8px] py-2 mb-6">
                <CustomSelect
                  className={"w-full"}
                  options={optionsStudio}
                  onChange={handleSelectChange}
                  showArrow={true}
                  defaultValue={optionsStudio[0]}
                />
              </div>
            ...
            <p
              className={
                "md:text-[#D4D3D2] text-[#494949] text-[18px] leading-[26px] font-['PT-Root-UI'] font-regular max-w-[380px]"
              }
            >
              {t("manager_contact")}
            </p>
